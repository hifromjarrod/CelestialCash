...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1700000000000);
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(17000000000);

const char     GENESIS_COINBASE_TX_HEX[]                     = "012801ff000180d49daa3f0253008f44efb5ccdb9118fb2793c536fb987c4d7c0a2fdd5252e57955efaf2824210162f00134f3d8d34fc8de06e948d3e6301da5f294b6fec5858daa2d186100e0ac";
...
/* The mixin to use by default with zedwallet and service */
...
const uint32_t UPGRADE_HEIGHT_V5                             = 10; // Upgrade height for CN-Soft Shell Variant 1 switch.
...
const char     CRYPTONOTE_NAME[]                             = "Celestial";
...
const int      P2P_DEFAULT_PORT                              =  27337;
const int      RPC_DEFAULT_PORT                              =  28337;
...
const char     LATEST_VERSION_URL[]                          = "http://latest.celestial.cash";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xa5, 0xb5, 0xc5, 0x6f, 0xcf, 0x3c, 0x73, 0x37, 0x63, 0xff, 0x99, 0x34, 0x66, 0xc1, 0xb3, 0xa9  }
};

const char* const SEED_NODES[] = {
  "198.245.53.229:27337",
  "198.245.53.230:27337"
};
}
