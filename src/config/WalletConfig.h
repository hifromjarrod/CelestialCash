...
namespace WalletConfig
{
    ...
    const std::string addressPrefix = "C";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "CELC";
    ...
    const std::string daemonName = "Celestiald";
    ...
    const std::string contactLink = "http://chat.celestial.cash";
